-- ==========================================
-- BLACKLIST & CONFIGURATION SYSTEM (URL BASED)
-- ==========================================
...
local function fetchBlacklist()
    ...
    if not success then
        warn("[Anti-Exploit] Nabigo sa pagkuha ng blacklist mula sa URL:", result)
        return {}
    end
...
local BLACKLISTED_USERS = fetchBlacklist()
...
if isBlacklisted(localPlayer) then
    ...
    -- Ititigil ang script dito para sa blacklisted player (Walang Key System na lalabas)
    return
end

-- ==========================================
-- KEY SYSTEM (LALABAS LAMANG KUNG HINDI BLACKLISTED)
-- ==========================================
...
-- Simulan lang ang Key System kung ligtas (hindi blacklisted) ang player
...
-- Maghihintay muna sa tamang key bago i-load ang pangunahing script
