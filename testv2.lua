...
-- ==========================================
-- CHECK KUNG BLACKLISTED ANG PLAYER
-- ==========================================
if isBlacklisted(localPlayer) then
    ...
    -- Hihinto agad ang buong script dito! HINDI NA LALABAS O GAGANA ANG KEY SYSTEM AT SCRIPT.
    return
end

-- ==========================================
-- KUNG HINDI BLACKLISTED: SAKA LANG LALABAS ANG KEY SYSTEM AT SCRIPT
-- ==========================================
...
-- I-execute lang ang UI at events kung HINDI blacklisted ang player
